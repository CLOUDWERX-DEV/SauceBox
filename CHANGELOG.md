...
- **Playlist Editor Dynamic Window Sizing**: Redesigned the Edit Playlist page layout to stretch and size dynamically with the window. Replaced the hardcoded `height: 650` with `height: 'calc(100vh - 180px)'`, matching viewport size changes instantly.
