...
- **Taller Cover Art Preview**: Substantially increased the height of the playlist cover thumbnail preview inside the editor panel header from `120` to `240`. This expands it to a gorgeous, high-fidelity landscape aspect ratio, showcasing cover art choices with dramatic, professional impact.
