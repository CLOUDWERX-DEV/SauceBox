...
- **GPLv3 Licensing**: Created a formal, production-grade `LICENSE` file in the root directory under the GNU General Public License version 3. This guarantees that SauceBox remains 100% free and open-source forever, protecting CLOUDWERX LAB's hard work from close-source commercial exploitation while permitting unrestricted community distribution and contribution.
