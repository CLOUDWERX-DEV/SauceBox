<p align="center">
  <img src="public/logo.png" width="256" height="256" alt="LocalFap Logo" />
</p>

<h1 align="center">LocalFap</h1>
...
```bash
git clone https://github.com/CLOUDWERX-DEV/LocalFap.git
cd LocalFap
npm install
```
