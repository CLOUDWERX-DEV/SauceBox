    ...
    <View style={{ height: '100%', padding: 32, paddingBottom: 32, overflow: 'hidden' }}>
      ...
      <View style={styles.editorContainer}>
        ...
        <View style={styles.editorRight}>
          <View style={styles.panelHeader}>
            <TouchableOpacity onPress={() => setCoverModalVisible(true)} style={{ width: '100%', height: 280, backgroundColor: theme.colors.surfaceLight, borderRadius: 8, overflow: 'hidden', marginBottom: 12, position: 'relative' }}>
